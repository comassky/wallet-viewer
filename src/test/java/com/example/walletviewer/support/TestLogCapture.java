package com.example.walletviewer.support;
...
public final class TestLogCapture implements AutoCloseable {
    public record Entry(int level, String message, Throwable thrown) { }
    ...
    public TestLogCapture(Class<?> category) {
    ...
    public List<String> messages() { return entries.stream().map(Entry::message).toList(); }
